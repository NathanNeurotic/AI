...
<body>
    ...
    <main>
        <div class="search-container">
            <input type="text" id="searchInput" placeholder="Search services..." aria-label="Search AI services">
        </div>
        <!-- All-in-One AI Assistants -->
        <section class="category" id="conversational-ai">
            ...
            <div class="category-content">
                ...
                <a href="https://www.chatgpt.com/" class="service-button" target="_blank">
                ...
                <a href="https://chat.deepseek.com/" class="service-button" target="_blank">
                    <img class="service-favicon" src="https://chat.deepseek.com/favicon.ico" onerror="this.src='./favicon.ico'" alt="Service favicon">
        ...
        <section class="category" id="video-generation">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Video Generation and Editing
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.capcut.com/" class="service-button" target="_blank">
        ...
        <section class="category" id="audio-generation">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Audio and Music Generation
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.aiva.ai/" class="service-button" target="_blank">
        ...
        <section class="category" id="coding-development">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Coding and Development
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://bolt.new/" class="service-button" target="_blank">
        ...
        <section class="category" id="research-data">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Research and Data Analysis
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.beautiful.ai/" class="service-button" target="_blank">
        ...
        <section class="category" id="developer-platforms">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Developer Platforms and APIs
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.ai21.com/" class="service-button" target="_blank">
        ...
        <!-- Healthcare AI -->
        <section class="category" id="healthcare-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Healthcare AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.aidoc.com/" class="service-button" target="_blank">
        ...
        <!-- Legaltech AI -->
        <section class="category" id="legaltech-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Legaltech AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.casetext.com/" class="service-button" target="_blank">
        ...
        <!-- Fintech AI -->
        <section class="category" id="fintech-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Fintech AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://kasisto.com/" class="service-button" target="_blank">
        ...
        <!-- Gaming AI -->
        <section class="category" id="gaming-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Gaming AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.convai.com/" class="service-button" target="_blank">
        ...
        <!-- 3D Modeling AI -->
        <section class="category" id="3d-modeling-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                3D Modeling AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.3daistudio.com/" class="service-button" target="_blank">
        ...
        <!-- Agriculture AI -->
        <section class="category" id="agriculture-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Agriculture AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.agrivi.com/" class="service-button" target="_blank">
        ...
        <!-- Travel AI -->
        <section class="category" id="travel-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Travel AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://amadeus.com/en/solutions/artificial-intelligence" class="service-button" target="_blank">
        ...
        <!-- Logistics AI -->
        <section class="category" id="logistics-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Logistics AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.fourkites.com/" class="service-button" target="_blank">
        ...
        <!-- Retail AI -->
        <section class="category" id="retail-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Retail AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.algolia.com/" class="service-button" target="_blank">
        ...
        <!-- Energy AI -->
        <section class="category" id="energy-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Energy AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.enelx.com/" class="service-button" target="_blank">
        ...
        <!-- Climate AI -->
        <section class="category" id="climate-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Climate AI
                <span class="chevron">▼</span>
            </h2>
            <div class="category-content">
                <a href="https://www.climate.ai/" class="service-button" target="_blank">
        ...
        <!-- Specialized AI -->
        <section class="category" id="specialized-ai">
            <h2 onclick="toggleCategory(this)" aria-expanded="false">
                Specialized AI
                <span class="chevron">▼</span>
            </h2>
    ...
    <footer>
        <p>© 2025 NathanNeurotic. All rights reserved.</p>
        <p class="thanks">Special Thanks to <a href="https://grok.com/" target="_blank">SuperGrok at grok.com</a></p>
    </footer>
