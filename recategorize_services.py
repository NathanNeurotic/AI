...
CATEGORY_KEYWORDS = {
    ...
    "💼 Enterprise & Productivity Solutions": ["enterprise", "productivity", "crm", "erp", "business intelligence", "sales", "marketing", "project manage", "hr", "finance", "document ai", "office tool", "collaboration", "workflow", "meeting", "accounting", "legal tech", "insurtech", "business process", "human resources"],
    ...
    "💬 Language, Communication & Interaction": ["language", "communication", "interaction", "chatbot", "conversational", "translation", "nlp", "speech", "text generation", "voice assistant", "customer support", "dialogue", "linguistic", "transcription", "natural language"],
    ...
    "🧠 Core AI Technologies": ["core ai", "machine learning", "deep learning", "neural network", "computer vision", "ai platform", "mlops", "framework", "algorithm", "data science", "model training", "inference", "artificial intelligence", "ai ethics", "expert system", "knowledge representation"],
